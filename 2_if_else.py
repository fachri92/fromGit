...
# pisang = 3000
# x = int(input('pembelian pisang mau berapa biji? '))
# if x*pisang > 100000:
#     print('Anda mendapatkan diskon 10 %')
#     print('Anda harus membayar sebesar ', (x*pisang)*0.9)
# elif 100000 > x*pisang > 50000:
#     print('Anda mendapatkan diskon 5 %')
#     print('Anda membayar ', (x*pisang)*0.95)
# else:
#     print('Anda tidak mendapatkan diskon')
#     print('Anda membayar ', (x*pisang))
...
# yos  = int(input('Berapa lama kamu bekerja'))

# if yos >= 10 :
#     print( 'Selamat Anda mendapat bonus sebesar', gaji*0.1)
#     print(" Total gaji anda", int(gaji*1.1))
# else :
#     print( 'anda ga dapet gaji')
...
p
'''
# user_1 = input('Masukkan umur user 1 : ')
# user_2 = input('Masukkan umur user 2 : ')
# user_3 = input('Masukkan umur user 3 : ')


# if user_1 == user_2 and user_1 > user_3 :
#     print('User 1 dan 2 paling tua')
# elif user_1 == user_3 and user_1 > user_3 :
#     print('User 1 dan 3 paling tua')
# elif user_2 == user_3 and user_2 > user_1 :
#     print('User 2 dan 3 paling tua')    
# elif user_1 > user_2 and user_1 > user_3 :
#     print('User 1 paling tua')
# elif user_2 > user_1 and user_2 > user_3 :
#     print('User 2 paling tua')
# elif user_3 > user_1 and user_3 > user_2 :
#     print('user 3 paling tua')
# else :
...
if kehadiran/kelas >= 3/4:
    print(f"Total kehadiran anda {kehadiran/kelas*100} %. anda diperbolehkan masuk ujian")
elif kehadiran/kelas < 3/4:
    print(f"Total kehadiran anda {kehadiran/kelas*100} %. anda tidak diperbolehkan masuk ujian")
