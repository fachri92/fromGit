...
#         else:
#             if attempt == 3:
#                 print(f'Password incorrect! you have {4-attempt} left')
#             else:
#                 print(f'Password incorrect! you have {4-attempt} left')
#             attempt += 1
...
#     print(f'nama saya {a_list[i]} saya kerjanya {b_list[i]}')
...
# for i, j in zip(a_list, b_list): #[('Budi', 'Kapiten'), ('Andi', 'Data Scientist'), ('Candi', 'Tour Guide')]
