...
#         x2 = int(x2)
#         if op == '+':
#             print(f'Hasil penjumlahan dari {x1} dan {x2} adalah {x1+x2}')
#         elif op == '-':
#             print(f'Hasil pengurangan dari {x1} dan {x2} adalah {x1-x2}')
#         elif op == 'x':
#             print(f'Hasil perkalian dari {x1} dan {x2} adalah {x1*x2}')
#         elif op == ':' :
#             print(f'Hasil pembagian dari {x1} dan {x2} adalah {x1/x2}')
#         elif op == "^" :
#             print(f'Hasil pemangkatan dari {x1} dan {x2} adalah {x1**x2}')
#         else :
#             print('Invalid Input')
#     else:
#         print('Invalid Input')
