...
# # # print("Value di dalam key 'address' nama jalan saja:", employee['address']['geo'])
# # # #                                                       ['mobil', 'motor][0] = 'mobil'
...
# # # GET
# # # print(employee.get('nama', 234))
# # # print(employee['address'].get('street')) #untuk ngambil dari dict dalam dict
...
# # print('Cari value 3,000,000 ada atau ngga?: ', 5 in employee['address'].values())
...
# print(f'Bahasa Inggris dari {hari.title()} adalah {days[hari].title()}')
...
print(hari_list)
Input = input(('Masukkan Hari (IND/ENG) = ').lower())

if Input in hari_list:
    day = day_list[hari_list.index(Input)]
    print(f'Bahasa Inggris dari {Input.title()} adalah {day.title()}')
elif Input in day_list:
    hari = hari_list[day_list.index(Input)]
    print(f'Bahasa Indonesia dari {Input.title()} adalah {hari.title()}')
else:
    print('Invalid Input')
# elif input in day_list:
#     print(f'Bahasa Indonesia dari {input.title()} adalah {')
